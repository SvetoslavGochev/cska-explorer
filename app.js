...
const LATEST_SQUAD_OVERRIDES = [
  ...
  { name: "Жордао Бруно", aliases: ["Бруно Жордао"], flag: "🇵🇹", roleBg: "Халф", roleEn: "Midfielder", matches: 6, goals: 0, assists: 1, hattricks: 0, impact: "2.00" },
  ...
  { name: "Брахими Мохамед", aliases: ["Мохамед Брахими"], flag: "🇫🇷", roleBg: "Халф", roleEn: "Midfielder", matches: 6, goals: 0, assists: 0, hattricks: 0, impact: "1.50" },
  { name: "Лапоухов Фьодор", aliases: ["Фьодор Лапоухов"], flag: "🇧🇾", roleBg: "Вратар", roleEn: "Goalkeeper", matches: 5, goals: 0, assists: 0, hattricks: 0, impact: "1.25" },
  { name: "Жан-Филип Гбамин", aliases: ["Жан-Филип Гбамен", "Гбамин Жан-Филип"], flag: "🇨🇮", roleBg: "Защитник", roleEn: "Defender", matches: 5, goals: 0, assists: 0, hattricks: 0, impact: "1.25" },
  { name: "Ебонг Макс", aliases: ["Макс Ебонг"], flag: "🇧🇾", roleBg: "Халф", roleEn: "Midfielder", matches: 4, goals: 0, assists: 0, hattricks: 0, impact: "1.00" },
  { name: "Панайотов Петко", aliases: ["Петко Панайотов"], flag: "🇧🇬", roleBg: "Халф", roleEn: "Midfielder", matches: 4, goals: 0, assists: 0, hattricks: 0, impact: "1.00" },
  { name: "Соле Исак", aliases: ["Исак Соле"], flag: "🇨🇫", roleBg: "Халф", roleEn: "Midfielder", matches: 4, goals: 0, assists: 0, hattricks: 0, impact: "1.00" },
  { name: "Лео Перейра", flag: "🇧🇷", roleBg: "Нападател", roleEn: "Forward", matches: 2, goals: 0, assists: 0, hattricks: 0, impact: "0.50" },
  { name: "Пиедраита Алехандро", aliases: ["Алехандро Пиедраита"], flag: "🇨🇴", roleBg: "Нападател", roleEn: "Forward", matches: 2, goals: 0, assists: 0, hattricks: 0, impact: "0.50" },
  ...
  { name: "Евтимов Димитър", aliases: ["Димитър Евтимов"], flag: "🇧🇬", roleBg: "Вратар", roleEn: "Goalkeeper", matches: 1, goals: 0, assists: 0, hattricks: 0, impact: "0.25" },
  { name: "Йорданов Андрей", aliases: ["Андрей Йорданов"], flag: "🇧🇬", roleBg: "Защитник", roleEn: "Defender", matches: 1, goals: 0, assists: 0, hattricks: 0, impact: "0.25" },

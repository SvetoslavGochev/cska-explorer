...
const LATEST_SQUAD_OVERRIDES = [
  ...
  { name: "Питас Йоанис", aliases: ["Йоанис Питас"], flag: "🇨🇾", roleBg: "Нападател", roleEn: "Forward", matches: 7, goals: 2, assists: 2, hattricks: 0 },
  ...
  { name: "Годой Леандро", aliases: ["Леандро Годой", "Сантяго Годой"], flag: "🇦🇷", roleBg: "Нападател", roleEn: "Forward", matches: 4, goals: 3, assists: 0, hattricks: 0 },
  ...
  { name: "Соле Исак", aliases: ["Исак Соле"], flag: "🇨🇫", roleBg: "Полузащитник", roleEn: "Midfielder", matches: 4, goals: 1, assists: 0, hattricks: 0 },
